...
Ein großer Nachteil des halbstandardisierten Interviewleitfadens ist, dass er einen gewissen Erfahrungsgrad von dem Interviewer verlangt:
...
Die einzelnen Frageblöcke im Leitfaden leiten sich aus der vorgestellten Theorie und Webanalyse ab und sollen dem Ziel dienen, die Frage \emph{Welche Faktoren beeinflussen die wahrgenommene Sicherheit von autonomen Fahrzeugen und Fahrassistenzsystemen}. Die Fragen wurden so geplant, dass die Interviews zwischen 30 und 45 Minuten dauern.
...
Die Interviews wurden alle in einem kurzen Zeitraum geführt und mit einem handelsüblichen Aufnahmegerät aufgenommen. Zur Transkription wurde MAXQDA benutzt. Die Transkripte liegen als Leseversion vor. Das bedeutet, dass Satzpausen und Gedankensprünge, also Dialogfragmente, die nicht zum Inhalt des Gesagten beitragen, entfernt worden sind. Meist ist es sinnvoll, nur so viel und so genau zu transkribieren, wie es das Forschungsziel verlangt (Flick 1995, S. 108).
